...
dataset_path="${project_path}/Aquifer_Anantharaman" #dataset specific
reads_path="${dataset_path}/reformatted_reads"
mapping_path="${dataset_path}/mappingResults"
ref_path="${dataset_path}/ref_genomes/bt2/all-aquifer-bins.fasta" #dataset specific
profile_path="${dataset_path}/profiles"
stb_path="${dataset_path}/ref_genomes/aquifer-stb.tsv" #dataset specific
fasta_path="${dataset_path}/ref_genomes/all-aquifer-bins.fasta" #dataset specific
