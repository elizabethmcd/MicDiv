...
r2_file=$(basename $reads _1.ref.fastq)_2.ref.fastq
samplename=$(basename $reads _1.ref.fastq)

# paths 
project_path="/home/GLBRCORG/emcdaniel/MicDiv/datasets"
dataset_path="${project_path}/Zymo_Synthetic" #dataset specific
reads_path="${dataset_path}/reformatted_reads"
mapping_path="${dataset_path}/mappingResults"
ref_path="${dataset_path}/ref_genomes/bt2/all-zymo-genomes.fasta" #dataset specific
profile_path="${dataset_path}/profiles"
stb_path="${dataset_path}/ref_genomes/zymo-scaffolds-to-genomes.tsv" #dataset specific
fasta_path="${dataset_path}/ref_genomes/all-zymo-genomes.fa" #dataset specific
